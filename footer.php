...
<footer class="footer" id="footer">
  ...
  <div class="footWording">
    <h5 class="footWordingTitle txtCenterLeft">About Us</h5>
    <p class="footWordingTxt">Ugiat nulla pariatur. Edeserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natu</p>
    <br>
