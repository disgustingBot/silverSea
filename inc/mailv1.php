...
<html style='overflow-x: hidden;'>
  ...
  <body>
    ...
    <header class='wrapper bg-2 padding-bottom-0 DP2'>
      ...
      <p class='px20 padding-bottom-16px'><strong>Cotización <span class='cliente'>$name</span> - <span class='pedido'>$title</span>$origen $destino</strong></p>
    </header>
    ...
    <div class='wrapper bg-1'>
      ...
      <p class='mailText'>
        Estimado $name, detallamos debajo la cotización por el pedido que ha solicitado en nuestra web.
        En breve nos pondremos en contacto con usted para asesorarlo acerca de las diferentes posibilidades que podemos ofrecerle.
      </p>
      <table class='mailBudget'>
        ...
        <tr class='budget-row budget-row-colored'>
            ...
            <td class='budget-title'><strong>$totalPrice</strong></td>
        </tr>
      </table>
    ...
    <div class='wrapper bg-4 padding-bottom-0 DP2'>
      ...
      <div class='socialMedia padding-bottom-16px'>
        <a class='socialMediaLink' rel='external' target='_blank' href='https://www.linkedin.com/company/silversea-trading-co.'>
          <img src='https://silverseacontainers.com/wp-content/uploads/2020/06/Linkedin.png' alt='Linkedin Logo'>
        </a>

        <a class='socialMediaLink' rel='external' target='_blank' href='https://www.facebook.com/silverseauy/'>
          <img src='https://silverseacontainers.com/wp-content/uploads/2020/06/Facebook.png' alt='Facebook Logo'>
        </a>

        <a class='socialMediaLink' rel='external' target='_blank' href='https://www.instagram.com/silversea.containers/'>
          <img src='https://silverseacontainers.com/wp-content/uploads/2020/06/Instagram.png' alt='Instagram Logo'>
        </a>

        <a class='socialMediaLink' rel='external' target='_blank' href='weixin://dl/chat?{sindertamimi}'>
          <img src='https://silverseacontainers.com/wp-content/uploads/2020/06/wechat.png' alt='Wechat Logo'>
        </a>
      </div>
    </div>
